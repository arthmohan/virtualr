  ...
  return (
    <div className="relative mt-10 border-b border-neutral-800 min-h-[800px]">
        <div className="text-center">
            <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-m font-medium px-2 uppercase">
                Features
            </span>
            <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:m-20 tracking-wide">
                Easily Build <span className="bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent">Your Code</span>
            </h2>
        </div>
